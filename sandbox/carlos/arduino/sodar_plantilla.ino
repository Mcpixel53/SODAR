...
#define ANGULO_MAX 60   // angulo maximo del barrido (en grados)
#define PASO_ANGULO 5   // paso de barrido (cantidad en que se incrementa el angulo de barrido)
...
void loop() {
  ...
  angulo = angulo + (PASO_ANGULO * direccion);
  if (angulo < ANGULO_MIN + 1) {
    direccion = ADELANTE;
  }
  if (angulo > ANGULO_MAX - 1) {
    direccion = ATRAS;
  }
