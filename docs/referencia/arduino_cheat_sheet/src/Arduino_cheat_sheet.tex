...
\begin{poster}%
  ...
  }
  {
    ...
    \includegraphics[]{OSHWI_color.png} % University logo
  }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Control de flujo}{name=control-stuctures,column=0,below=structure}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{tabular}{l}
    \texttt{\textbf{if}(x<5)\{\}}  \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Sintaxis adicional}{name=further-syntax,column=0,below=control-stuctures}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{tabular}{l l}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Operadores}{name=general-operators,column=0,below=further-syntax}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{tabular}{l l}
    \textbf{$=$} &  asignación \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Operadores de bit}{name=bitwise,column=0,below=general-operators}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{tabular}{l l}
    \textbf{$\&$} &  AND \\
    \textbf{$|$} & OR \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Operadores con asignación}{name=compound,column=0,below=bitwise}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{tabular}{l l}
    \textbf{$\%=$} & módulo \\
    \textbf{$+=,$ \hspace{2pt} $ -=$} & suma, resta \\
    \textbf{$*=,$ \hspace{2pt} $ /=$} &  multiplicación, division \\
    \textbf{$\&=,$ \hspace{2pt} $ |=$} &  AND, OR \\
    \textbf{$\wedge=,$ \hspace{2pt} $ \sim=$} & XOR, NOT \\
  \end{tabular}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Tipos de datos}{name=datatypes,column=1,below=constants}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{tabular}{l l}
    \textbf{void} & \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Arrays}{name=arrays,column=1,below=datatypes}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{tabular}{l}
    int myInts[6];  \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{tabular}{l l}
    \textbf{static} &  Persiste entre llamadas \\
    \textbf{volatile} & Usa RAM (interesante para ISR) \\
    \textbf{const} &  Sólo lectura \\
    \textbf{PROGMEM} & Usa meoria flash \\
  \end{tabular}
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{tabular}{l}
    \textbf{attachInterrupt}(interrupcion, funcion, tipo)  \\
    \textbf{detachInterrupt}(interrupcion)  \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{E/S Avanzada}{name=advancedio,column=2,below=interrupts}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{tabular}{l}
    \textbf{tone}(pin, freqhz)  \\
    \textbf{tone}(pin, freqhz, duracion\_ms)  \\
    \textbf{noTone}(pin)  \\
    \textbf{shiftOut} (pinDatos, pinReloj, how, valor)  \\
    unsigned long \textbf{pulseIn}(pin, [HIGH,LOW])  \\
  \end{tabular}
}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Tiempo}{name=time,column=2,below=advancedio}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{tabular}{l l}
    unsigned long \textbf{millis()} &  50 dias overflow\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \begin{tabular}{l}
    \textbf{pow}(base, exponente)  \\
    \textbf{map}(valor, deL, deH, aL, aH) \\
    \textbf{constrain}(valor, deL, aH) \\
  \end{tabular}
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Pines E/S}{name=pins,column=2,below=random}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{center}
  \begin{tabular}{l l l}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{E/S Analógica}{name=analog,column=3}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{tabular}{l}
    \texttt{\textbf{analogReference}(\texttt{EXTERNAL, INTERNAL})}  \\
    \texttt{int \textbf{analogRead}(pin)}  \\
    \texttt{\textbf{analogWrite}(pin,valor)} $\rightarrow$ PWM \\
  \end{tabular}
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{tabular}{l}
    ...
    \texttt{\textbf{digitalWrite}(pin, valor)}  \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{center}
    \includegraphics[width=\textwidth,angle=90]{./images/ARDUINO_UNO_PATAS.png}
  \end{center}
}
